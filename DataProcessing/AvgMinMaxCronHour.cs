...
{
    public class AvgMinMaxCronHour : CronJobService
    {
        private readonly ILogger<AvgMinMaxCronHour> _logger;
        readonly WeatherDB _Db;

        public AvgMinMaxCronHour(IScheduleConfig<AvgMinMaxCronHour> config, ILogger<AvgMinMaxCronHour> logger, WeatherDB Db)
        ...
        {
            _logger.LogInformation("CronJob AvgMinMaxHour Start");
        ...
        public override async Task DoWork(CancellationToken cancellationToken)
        {
                ...
                _logger.LogInformation("Sace mongoDB hour AWG at:{time}", DateTimeOffset.Now);
        ...
        {
            _logger.LogInformation("CronJob AvgMinMax hour Stop");
